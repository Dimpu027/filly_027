...
Resolution order for every key:
    settings.PLUGIN_CONFIGS["care_payroll"][key]  →  environment variable  →  DEFAULTS[key]
...
from care_payroll.apps import PLUGIN_NAME
...
class PluginSettings:  # pragma: no cover
    ...
    >>> from care_payroll.settings import plugin_settings
    >>> plugin_settings.PAYROLL_ENABLED
    """
